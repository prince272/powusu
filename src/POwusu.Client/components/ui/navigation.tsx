...
import { createContext, forwardRef, Suspense, useCallback, useContext, useEffect, useState } from "react";
...
const Link = forwardRef<HTMLAnchorElement, React.ComponentProps<"a">>(function Component({ href, onClick, ...rest }, ref) {
  const { onRouteChangeStart } = useRouteChangeContext();
