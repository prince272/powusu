...
export const ComboboxItem = withRef<"div", ComboboxContentItemProps>(({ combobox, index, item, onRenderItem, className, ...rest }, ref) => {
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "hover:bg-default-200 hover:text-default-600 data-[highlighted=true]:bg-default-200 data-[highlighted=true]:text-default-600",
        className
      )}
      {...props}
      {...rest}
    ...
    <Popover.Root open>
      ...
      <Popover.Portal container={portalElement}>
        <Popover.Content
          ...
          side="bottom"
          align="start"
          className={cn("z-[500] m-0 max-h-[288px] w-[300px] overflow-scroll rounded-md bg-content1 p-0 shadow-md")}
...
export function Combobox({ id, trigger, searchPattern, onSelectItem, controlled, maxSuggestions, filter, sort, disabled: _disabled, ...props }: ComboboxProps) {
