...
>(({ state, children, ...props }, componentRef) => {
  ...
  return (
    <PortalBody>
      <Toolbar ref={ref} className={cn("absolute z-50 whitespace-nowrap border border-default-200 bg-content1 px-1 opacity-100 shadow-md print:hidden")} {...rootProps} {...props}>
        {children}
      </Toolbar>
    </PortalBody>
  );
