            ...
            >
              ...
              {isVideo ? (
                isYoutube ? (
                  ...
                  >
                    <iframe
                      className={cn("size-full absolute left-0 top-0 rounded-sm", isVideo && "border-0", focused && selected && "ring-ring ring-2 ring-offset-2")}
                      src={embed!.url}
                      title="embed"
                      allowFullScreen
                    />
              ...
              <ResizeHandle options={{ direction: "right" }} className={mediaResizeHandleVariants({ direction: "right" })} />
            </Resizable>
