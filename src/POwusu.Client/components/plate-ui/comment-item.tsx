  ...
  return (
    <div>
      <div className="relative flex items-center gap-2">
        ...
        <div className="text-muted-foreground text-xs leading-none">{formatDistance(comment.createdAt, Date.now())} ago</div>
      ...
      <div className="mb-4 pl-7 pt-0.5">{editingValue ? <CommentValue /> : <div className="whitespace-pre-wrap text-sm">{commentText}</div>}</div>
    </div>
  );
}
