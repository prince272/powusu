    ...
    <section id="work" className="bg-[var(--surface-soft)] py-24 sm:py-32">
      <div className="section-shell">
        <div className="mb-12 flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
          <div><p className="eyebrow mb-4">Selected work</p><h2 className="display-title text-5xl sm:text-7xl">Projects with a <span className="text-gradient text-gradient-animated">purpose.</span></h2></div>
            ...
            <Card key={work.id} variant="default" className="group overflow-hidden border-0 bg-[var(--surface)] shadow-none transition-transform duration-300 hover:-translate-y-1">
              <Card.Content className="p-0">
                ...
                <div className="p-6 sm:p-8">
                  ...
                  <Button variant="primary" className="mt-7 w-full sm:w-auto" onPress={() => window.open(work.link, "_blank")}><ExternalLink size={18} strokeWidth={2.4} /> View project</Button>
                </div>
              </Card.Content>
            </Card>
          ))}
