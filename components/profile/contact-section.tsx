...
import { ArrowUpRight, Briefcase, Clapperboard, GitFork, Mail, MessageCircle, MessagesSquare } from "lucide-react";
...
export function ContactSection() {
  const socialLinks = [
    ...
    { label: "TikTok", note: "Watch my video work", href: siteConfig.links.tiktok, icon: Clapperboard, accent: "text-[#72b7ff]" }
  ];
